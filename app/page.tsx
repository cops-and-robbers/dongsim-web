  ...
  "@graph": [
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "실시간 GPS 위치 추적, 자유로운 플레이 구역 설정, 주기별 발자국 공개 시스템, QR 스캔 체포 시스템, 팀 분리 채팅 기능이 모두 무료로 제공됩니다. iOS와 Android 모두 지원하며, 최대 50명까지 함께 플레이할 수 있는 위치 기반 멀티플레이어 게임입니다.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "최소 2명부터 최대 50명까지 함께 플레이할 수 있어요. 친구들끼리 모여 경찰 팀과 도둑 팀으로 나뉘어 진행합니다.",
          },
        },
        {
          "@type": "Question",
