...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-slate-200 bg-slate-50 transition-colors duration-500 dark:border-white/10 dark:bg-app-black-900">
        ...
        <div className="grid gap-10 md:grid-cols-3 md:gap-12">
          ...
          <div>
            ...
            <a
              ...
              className="mt-5 inline-block text-sm font-medium text-slate-700 transition-colors hover:text-brand-blue dark:text-slate-200 dark:hover:text-brand-green"
            >
              {BRAND.email}
            </a>
